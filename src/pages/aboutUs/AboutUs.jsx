                    ...
                    <div className={classes.tableBox}>
                        ...
                        <ul>
                            <li>이용시간
                                <div>
                                    <ul>
                                        <li>이용 시간은 30분 단위로 선택한 영화에 따라 자동 적용되며, 최소 이용 시간은 2시간부터 입니다.</li>
                                        <li>보다 청결한 환경 제공을 위해 상영 종료 후 30분간은 청소 시간으로 운영됩니다.</li>
                                        <li>다음 예약이 예정되어 있는 경우, 청소 시간이 충분히 확보되지 않으면 예약이 제한될 수 있으니 양해 부탁드립니다.</li>
                                    </ul>
                                </div>
                            </li>
                            <li> 정원기준
                            ...
                            <li>예약 및 입장 :당일 예약은 불가합니다. 반드시 사전 예약 후 이용해 주세요.</li>
                            <li>장비안내
                                <div>
                                    <ul>
